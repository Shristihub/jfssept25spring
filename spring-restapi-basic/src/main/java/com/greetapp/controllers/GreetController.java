...
// the calss having the rest end points
@RestController
public class GreetController {
	...
	// date comes in the url of the request - @PathVariable
	...
	// placeholder name and parameter name are different use only @PathVariable("name")
